...
//            {
//                SL.SL_Log($"{Time.time} | Waiting for scene to be ready...");
...
//            {
//                SL.SL_Log($"{Time.time} | Waiting for players to be done loading...");
//                yield return new WaitForSeconds(1f);
//            }
...
//        //    {
//        //        SL.SL_Log("[CustomScenes] Populating necessary scene contents...");
...
//        //                SL.SL_Log($"[CustomScenes] - Created core object '{obj.name}'");
//        //            }
//        //            catch (Exception e)
//        //            {
//        //                SL.SL_Log($"Exception instantiating core object '{go.name}'");
//        //                SL.SL_Log($"{e.GetType()}, {e.Message}\r\n{e.StackTrace}");
//        //            }
//        //        }
//        //    }
//        //    else
//        //    {
//        //        SL.SL_Log("[CustomScenes] Could not get internal SL pack!");
//        //    }
//        //}
//    }
//}
