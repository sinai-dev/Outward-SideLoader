...
//namespace SideLoader.Inspectors.GameObjects
//{
...
//            s_positionControl.fullValue.text = go.transform.position.ToString();
...
//            s_localPosControl.fullValue.text = go.transform.localPosition.ToString();
...
//            s_rotationControl.fullValue.text = go.transform.eulerAngles.ToString();
...
//            s_scaleControl.fullValue.text = go.transform.localScale.ToString();
...
//                else
//                {
//                    SL.Log($"Could not find any GameObject from name or path '{input}'! Note: The target must be enabled.");
//                }
//            }
//        }
