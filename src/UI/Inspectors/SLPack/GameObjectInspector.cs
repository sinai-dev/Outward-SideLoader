...
//using SideLoader.Inspectors.GameObjects;
...
//            if (!TargetGO)
//            {
//                SL.LogWarning("Target GameObject is null!");
//                return;
//            }
...
//                var path = TargetGO.transform.GetGameObjectPath(true);
//                if (m_lastPath != path)
//                {
//                    m_lastPath = path;
...
//            m_pathInput.text = TargetGO.transform.GetGameObjectPath();
