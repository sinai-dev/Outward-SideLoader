...
namespace SideLoader.UI
{
    ...
    public class PanelDragger
    {
        ...
        public void OnDrag()
        {
            Vector3 diff = Input.mousePosition - m_lastDragPosition;
            m_lastDragPosition = Input.mousePosition;
        ...
        private void UpdateHoverImagePos()
        {
            ...
            s_resizeCursorObj.transform.localPosition = t.InverseTransformPoint(Input.mousePosition);
        }
        ...
        internal static void LoadCursorImage()
        {
            ...
            {
                SL.LogWarning("Exception loading cursor image!\r\n" + e.ToString());
            }
        }
...
//            SLPackListView.OnToggleShow += OnEndResize;
//        }
...
//        private bool MouseInResizeArea(Vector2 mousePos)
//        {
//            bool ret = m_resizeRect.Contains(mousePos);
...
//            MainMenu.Instance.m_mainImage.color = mask != 0
...
//        //{
//        //    RectTransform t = UIManager.CanvasRoot.GetComponent<RectTransform>();
//        //    s_resizeCursorImage.transform.localPosition = t.InverseTransformPoint(Input.mousePosition);
//        //}
