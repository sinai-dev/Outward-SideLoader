...
//                SL.LogWarning($"Exception evaluating: {e.GetType()}, {e.Message}");
//                ReflectionException = $"{e.GetType()}: {e.Message}";
//            }
...
//                if (At.GetTypeByName(input) is Type t)
//                {
...
//                            {
//                                SL.LogWarning($"Generic argument #{i}, '{input}' is not assignable from the constraint '{constraint}'!");
//                                return null;
//                            }
//                        }
...
//                else
//                {
//                    SL.LogWarning($"Generic argument #{i}, could not get any type by the name of '{input}'!" +
